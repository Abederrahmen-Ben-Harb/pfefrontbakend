...
import com.abederrahmen.bng.payload.request.LoginRequest;
import com.abederrahmen.bng.payload.request.SignupRequest;
import com.abederrahmen.bng.payload.response.JwtResponse;
...
import com.abederrahmen.bng.security.jwt.JwtUtils;
import com.abederrahmen.bng.security.services.UserDetailsImpl;
		...
		if (strRoles == null) {
			...
			strRoles.forEach(role -> {
				...
				case "admin":
					...
					break;
				case "adminmet":
					Role adminMetRole = roleRepository.findByName(ERole.ROLE_ADMINMET)
							.orElseThrow(() -> new RuntimeException("Error: Role is not found."));
					roles.add(adminMetRole);

					break;
				case "chercheur":
					Role chercheurRole = roleRepository.findByName(ERole.ROLE_CHERCHEUR)
							.orElseThrow(() -> new RuntimeException("Error: Role is not found."));
